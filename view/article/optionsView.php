<form class="form" method="post" action="index.php?page=article">
    ...
    <div class="dropdown ">
        ...
        <ul class="dropdown-menu p-0" aria-labbeledby="myButton">
            ...
            <?php } ?>
            <li><button type="button" class="btn btn-danger border rounded-0 rounded-bottom w-100" data-bs-toggle="modal" data-bs-target="#delete-<?php echo $isArticle ? "art-" : "com-";
                                                                                                                                                    echo $id_artOrCom ?>">
